        ...
        <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700" >
            <form class=" space-y-6" action="/register" method="post">
                ...
                <h5 class="text-xl font-medium text-gray-900 dark:text-white">Create account</h5>
                        ...
                        <div class=" hidden">
                            <label class="block mb-1 text-sm font-medium text-gray-900 dark:text-white"> User Roll: </label>
                        ...
                        <div>
                            <label class="block mb-1 text-sm font-medium text-gray-900 dark:text-white"> dob: </label>
                        ...
                        <div>
                            <label class="block mb-1 text-sm font-medium text-gray-900 dark:text-white"> joined_date: </label>
                        ...
                        <div class=" hidden">
                            <label class="block text-sm font-medium text-gray-900 dark:text-white"> hourly_rate: </label>
                        ...
                        <div>
                            <div class="w-full mb-1 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
