...
<div class=" flex justify justify-center ">
    <div class=" bg-white border border-gray-200 rounded-lg shadow p-6 dark:bg-gray-800 dark:border-gray-700" >
            ...
            <form action="{{url('user')}}" method="POST" class=" ">
                ...
                <div class=" ">
                    ...
                    <input class=" w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" type="text" name="name">
                </div>
                <div>
